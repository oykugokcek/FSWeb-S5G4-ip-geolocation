...
function createComponent(obj) {
  ...
  ulke.textContent = "".concat(obj.ülke, " ").concat(obj.ülkeKodu);
  enlemBoylam.textContent = "Enlem: ".concat(obj.enlem, " Boylam: ").concat(obj.boylam);
...
var cardDiv = _axios.default.get("https://apis.ergineer.com/ipgeoapi/31.145.249.45").then(function (response) {
  document.querySelector(".cards").appendChild(createComponent(response.data));
}).catch(function (err) {
